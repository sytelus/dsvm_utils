...
alias gviewcommits='git log --pretty=oneline  -n 10'
alias gclean='git clean -fdx'
alias gcreatebranch='git checkout -b $1'
alias gdeletebranch='git push origin -delete $1 && git branch -d $1'
alias gpendingconf='git diff --name-only --diff-filter=U'
alias s='bash'
alias madaptshare='sudo mount -t cifs //adaptshare/SafeCPS /mnt/adaptshare/SafeCPS -o username=shitals,domain=redmond,iocharset=utf8'
alias bashrt='cd /mnt/c/Users/$USER/AppData/Local/lxss/rootfs'
alias simhil='jmav && java -Djava.ext.dirs= -cp lib/*;out/production/jmavsim.jar me.drton.jmavsim.Simulator -serial COM4 115200 -qgc'
alias simsil='jmav && java -cp lib/*;out/production/jmavsim.jar me.drton.jmavsim.Simulator -udp 127.0.0.1:14560'
